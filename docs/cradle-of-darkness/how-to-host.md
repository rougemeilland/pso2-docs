...
> [!TIP]
> だいたいの流れをつかんでおられればお分かりだと思いますが、たとえ最終周でも終わった後は参加者の皆さんは慌しく退出していきますので、最後のあいさつの時間はテレポータ起動前に設けた方がいいでしょう。
...
>
> なので、理想なのは **「全員あまり離れずに行動する」**、**「残っている雑魚エネミーを放置して進みすぎない」**、**「ボスを倒すことよりも、(必要ならボスを雑魚エネミーのPOP地点から引き離して) POPした雑魚エネミーを速やかに倒すことに注力する」**、のようなことだと筆者は考えます。
>
