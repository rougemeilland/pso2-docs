...
**あくまで筆者のやり方であり、強制したり強くお勧めするものではありません。** どなたかの参考になれば幸いです。
...
筆者が主催していた場合、ではありますが、ゆりかごT開催前、あるいは開催中に以下の緊急クエストが発生した場合、ゆりかごTの中止あるいは開始時刻の延期を検討します。
...
筆者であれば、緊急の終了後にトリガーを貼るか、もし残り時間的にその余裕がなければ、トリガーの中止を宣言します。
...
筆者なら、緊急ゆりかごの場合と同様に延期または中止を検討します。~~ていうか、私も慟哭行きたい。~~
...
なので、鑑定中の参加者への催促？や、参加者が不足している場合の追加募集のために、主催は他の参加者より最後にキャンプシップへ入る方がやりやすいです。
...
主催は、テレポータ付近の人数が多くなってきたり、(事前に鑑定時間を決めている場合は) 鑑定時間が経過したら、「そろそろ開始するので急いでください」などを白チャで呼びかけた後、自分もテレポータ前に降ります。
...
> 
> 筆者の経験上ではありますが、そういった方法の場合、終盤の参加者が激減してしまい中途半端に人数が残ってしまったりして、参加者の気分的にも効率的でもあんまりよろしくないことが多かったように思います。
> 
...
主催は、他の参加者と違って、最初から最後まで参加しなければならず、しかもトリガー主にはレアドロ率UPのブーストがかかるようなので。
...
PSEバーストが発生するかどうかは運任せではあるのですが、ある程度発生させやすくはできるので、その辺について紹介しようと思います。

#### [PSEバースト中は、エネミーはプレイヤーの周囲に再POPする]

NGS の PSE バーストでは、エネミーはある固定値店の周囲に再POPしますが、旧PSO2では各プレイヤーの周囲に再POPします。

なので、プレイヤーがある地点に集まり、エネミーのPOP地点も予測しやすく、そこを狙って範囲攻撃で一掃、というやり方が一般的です。

一方、プレイヤーが散らばっていると、それぞれのプレイヤーの周囲にエネミーが再POPするため、倒すのに時間がかかってしまいます。

#### [PSEバーストの延長回数は無制限]

また、NGS ではPSEバーストの延長が1回 (最大2回？) の「アンコール」



また、PSEバーストの時間の延長 (「ワンモア」とか「クロスバースト」とか) が発生しやすくなるためにも、一定時間内に途切れなくできるだけ多くのエネミーを倒すことが重要なので、

### 7.3 主催観点でありがたい参加者

これもどちらかというと、一般参加者向けの内容ですが、一応。
：雑魚優先、ボスのヘイトを確保してくれる人
