...
![征くぞアークス 倉庫の空きは充分か!](./img/征くぞアークス倉庫の空きは充分か.png "征くぞアークス 倉庫の空きは充分か")
...
中止という事態にならないことがベストなのですが、残念ながら、たまには中止せざるを得ない場合もあります。

##### ケースA) 参加者の人数が足りない場合

ゆりかごTというのはクリアが目的ではなく、如何に多くのエネミーを倒すか、が目的です。**「収入≒ドロップアイテム数≒討伐エネミー数」** であり、多くの参加者が (経験値もおいしいですが)
収入を求めて参加するからです。
特に **「PSEバーストでは同時に再POPするエネミーの数は参加者数と同じ」** という性質があるため、参加者が多ければその分PSEバースト中のドロップの数は増える、つまり収入が増えます。

<br/>

なので、参加人数が足りない場合、主催はまだテレポータ前には降りずに、クエストカウンター周辺や、鑑定ショップ周辺で、白チャで追加募集を試みます。

※例 「ゆりかごT 募集中 ＠５」 など

> [!TIP]
> 意外と知らない人がたまにいますが、ゲートエリア (クエストカウンター付近) で発言した白チャはショップエリア (鑑定ショップ付近) にいるプレイヤーには聞こえません。
> 同様に、ショップエリア (鑑定ショップ付近) で発言した白チャはゲートエリア (クエストカウンター付近) にいるプレイヤーには聞こえません。
>
> プレイヤーへの呼びかけをする際には、両方で同じ内容の発言をした方がいいでしょう。

<br/>

「何人まで集めようか？」というのも考慮する必要があります。既にクエストを受注している方を待たせているわけですから、そんなに長時間追加募集をするわけにはいきません。

フルメンバーになっていなくても、適当なところで募集を打ち切って、主催もテレポータ前に降りましょう。

<br/>

しかし、追加募集を行っても十分な数の参加者が集まらない場合は致し方ありません。無い袖は振れない、絵に描いた餅、というやつです。
...
何故ならば、憎悪を待ち望んでいるプレイヤーは非常に多く、ゆりかごTの参加希望者が激減する可能性が高いからです。
憎悪参加者は、緊急予定時刻の1時間前から準備をして、緊急が終わった後も疲労困憊でトリガー参加どころじゃない、という方が多いようなので、尚更です。
...
そのため、テレポータ前にまだ全員集まっていない状態でテレポータを起動すると、突入後に少ない数のエネミーしかPOPしないので、その分収入は減ります。
...
3) 主催は、以下の何れかになったら、「そろそろ開始するので急いでください」などを白チャで呼びかけた後、自分もテレポータ前に降りる。
    ...
    - (事前に鑑定時間 (例えば最長で3分間とか) を決めている場合は) 鑑定時間が経過した場合
...
> 
> なので、例えば **「今トリガーを貼ったから、良かったから来てね♪」** とやっても、フルメンバー (12人) に達するまでに相当の時間 (数十分以上) がかかることは覚悟してください。それどころか、募集に時間がかかりすぎて途中で脱退者が出たりしてそもそも十分な人数が集まらない可能性もあります。
> 
...
>
> 筆者の鯖では、たとえ、十分な宣伝時間を設けたとしても、参加希望者の数は24人には到底届きません。
> 
...
> [!WARNING]
> **「2の日」(毎月 1日、2日、3日、21日、22日、23日) は NGS をプレイする方が多くなるためか、旧PSO2のトリガーの参加者が減る傾向がある** ので、筆者は2の日の主催はできるだけ避けるようにしています。
...
宣伝時間は長いほど効果的ではありますが、宣伝時間の分だけ主催者の拘束時間も長くなりますし、あまりプレイヤーがログインしていない時間帯での看板はそれほど効果的ではありません。
どれだけ前から看板を出すかは主催者次第です。

複数のアカウントを持っている主催者の方は、24時間前から看板を出していることもあるようです。
...
> 
> PSEバーストが長引くと、ドロップアイテムが基本倉庫にも入りきれずにプレミアム倉庫に格納されるようになることがよくあります。
> 
...
> [!TIP]
> これは主催者に限りませんが、ユニットに **「レアドロ倍率上昇3」の時限能力インストール** をするのもいいと思います。ゆりかごの場合の効果発揮条件は **「アークス船団周辺宙域」** で、1部位につき 3% ほどの上昇のようですので、3部位だと `1.03 × 1.03 × 1.03 = 1.092727` となり、約 9.3% だけレアドロ率が上昇することになります。
>
> ただ、時限能力データを用意するのも無料ではありませんし、自分で作れない人の場合は作れる人にクラフト依頼をするしかありません。
>
> また、他のクエストのために別の時限能力を常用していたりすると、まだ有効期間が残っていてもゆりかごの前に時限能力を入れ替えなければならなくなります。
> 
> なので時限能力をインストールするのは「自分のお財布その他と相談して可能ならやった方がいい」というレベルでしょうか。
...
一般参加者が加入してきても主催者が気にしないなら別に構わないのですが、よく知らない一般参加者に主催PTに入って欲しくない場合は、あらかじめパーティーコマンド画面でパスワードを設定しておくといいでしょう。

![パーティー設定で主催PTをパスワードでロックする](./img/パーティーのパスワードロック.png "主催PTをパスワードでロックする")

パーティーコマンド画面で以下の項目をONにするという手もあるのですが、そうするとどうやら参加者がパーティー名一覧を表示したときに下の方に表示されてしまうらしく、不親切であるようです。
- フレンド限定
- チームメンバー限定
...
逆に、プレイヤーが散らばっていると、それぞれのプレイヤーの周囲にエネミーがばらばらに再POPするため、倒すのに時間がかかってしまいます。
...
> [!NOTE]
> 例外として、優先して倒した方がいいボスとして、「グワナーダ」があります。
>
> 理由は、グワナーダが地面に潜ってる間はダメージを全く与えることができないので、これを最後に残してしまうと、攻略を次に進めるのに余分に時間がとられてしまうからです。
>
> 理想的なのは
> 1) 雑魚エネミーがPOPしている間は、雑魚エネミーを優先しつつ、グワナーダを殴る
> 2) グワナーダが沈んだら、ダークラグネにいつでもとどめを刺せるようにHPを減らしつつ、雑魚エネミーを優先して倒し続ける
> 3) 雑魚エネミーの再POPが止まったら、ダークラグネにとどめを刺す
> 
> というようなことのようです。
>
> あくまで理想的にはなので、野良トリガーにそこまで期待する方が間違いだと思いますが。

> [!NOTE]
> ボス戦中の雑魚エネミーの再POPにはある特徴があります。
>
> 数体のエネミーが一斉にPOPして、それらの再POPしたエネミーを1体残らず倒すまでは次の再POPは発生しないようです。
>
> なので、ボス戦中の雑魚エネミーの再POPが止まったように見えたら、付近に雑魚エネミーの取りこぼしがないかくまなく探しましょう。
